      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-1 gap-8">
            <div className="bg-red-50 p-6 rounded-xl text-center group hover:bg-red-100 hover:shadow-xl hover:scale-105 transition-all duration-300">
          ...
          {/* Contact Form */}
          <div className="bg-red-600 p-8 rounded-xl shadow-lg group hover:shadow-xl transition-all duration-300">
